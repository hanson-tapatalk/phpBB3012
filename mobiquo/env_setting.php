...
switch ($request_method)
{
    ...
    case 'register':
    	...
    	$_POST['email'] = strtolower($request_params[2]);
    ...
    case 'update_email':
    	...
    	$_POST['creation_time'] = time();
		$_POST['cur_password'] = !isset($request_params[2]) ? $request_params[0] : 'true';
    	$_POST['email'] = !isset($request_params[2]) ? strtolower($request_params[1]) : strtolower($request_params[0]) ;
    ...
    case 'prefetch_account':
    	$_POST['email'] = strtolower($request_params[0]);
    	break;
    case 'search_user':
    	$_POST['username'] = $request_params[0];
    	$_POST['email'] = strtolower($request_params[0]);
